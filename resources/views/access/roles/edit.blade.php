...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="h4 mb-0">Edit Role – {{ $role->name }}</h1>
            <small class="text-muted">Update role name (optional) and permissions</small>
        </div>
        <div>
    ...
    @php
        ...
        // If validation failed, keep old checked state, else use current role permissions.
        $oldPermissions = (array) old('permissions', $rolePermissionNames);
    @endphp
