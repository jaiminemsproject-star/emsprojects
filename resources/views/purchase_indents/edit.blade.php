                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="required_by_date" class="form-control form-control-sm"
                               value="{{ old('required_by_date', optional($indent->required_by_date)->format('Y-m-d')) }}" required>
                    </div>

                    <div class="col-md-12">
                        <label class="form-label">Remarks</label>
                        <textarea name="remarks" rows="2" class="form-control form-control-sm">{{ old('remarks', $indent->remarks) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
