    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">{{ isset($user->id) ? 'Edit User' : 'Create User' }}</h1>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">
                                    ...
                                    @if(setting('password_require_uppercase', true)), with uppercase@endif
                                    @if(setting('password_require_number', true)), with number@endif
                                    @if(setting('password_require_special', false)), with special character@endif
                                </small>
                            </div>
