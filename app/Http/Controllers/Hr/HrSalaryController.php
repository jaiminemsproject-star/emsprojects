    ...
    public function storeEmployeeSalary(Request $request, HrEmployee $employee): RedirectResponse
    {
        ...
        try {
            ...
            $salary = HrEmployeeSalary::create([
                ...
                'gross_salary' => $gross,
                'pf_applicable' => $validated['pf_applicable'] ?? false,
                'pf_employee' => $pfEmployee,
                'pf_employer' => $pfEmployer,
                'esi_applicable' => $validated['esi_applicable'] ?? false,
                'esi_employee' => $esiEmployee,
                'esi_employer' => $esiEmployer,
                'pt_applicable' => $validated['pt_applicable'] ?? false,
                'professional_tax' => $pt,
                'tds_applicable' => $validated['tds_applicable'] ?? false,
                'lwf_applicable' => $validated['lwf_applicable'] ?? false,
